...
There's also a moat consideration. Outcome pricing can raise [switching cost](/glossary/switching-cost/) in a specific way: once a vendor has a measurement baseline embedded in the customer's reporting, replacing that vendor means re-baselining against a new measurement system, which is operationally painful and often politically risky. That is a feature if you're the incumbent and a bug if you're trying to dislodge one.
