...
SWPS is one of Poland's leading private universities, particularly strong in psychology and social sciences. The academic work grounds everything I do commercially. Psychometric validation at [Gyfted](/work/gyfted). Capability measurement at [Nerds.family](/work/nerds-family). Experimental discipline in growth testing and product decisions at [Digital Savages](/work/digital-savages). The UX Design diploma added another layer — a sharper sensitivity to how complex systems are experienced by the people who actually use them.
