...
- [The Sleep Problem](#the-sleep-problem)
- [Layer 1: Self-Healing Healthcheck](#layer-1-self-healing-healthcheck)
- [Layer 2: The Status Dashboard](#layer-2-the-status-dashboard)
- [The Diagnostic Companion: wp-status-fix](#the-diagnostic-companion-wp-status-fix)
- [Layer 3: The Watchdog Telegram Bot](#layer-3-the-watchdog-telegram-bot)
- [Log Analysis and Resource Planning](#log-analysis-and-resource-planning)
- [Security and SEO Audits](#security-and-seo-audits)
- [Disaster Recovery](#disaster-recovery)
- [Scaling and Operations](#scaling-and-operations)
- [Seven Posts Later](#seven-posts-later)
...
## The Diagnostic Companion: wp-status-fix
...
## Layer 3: The Watchdog Telegram Bot
...
## Log Analysis and Resource Planning
...
I run `wp-usage` monthly or whenever I'm considering adding a new site to a server. It replaced guesswork with data.

## Security and SEO Audits
...
This series started as an experiment. I'm a psychologist and product person, not a systems administrator. I had a Hetzner account, some WordPress sites that needed better hosting, and a hypothesis that AI could close the expertise gap between "comfortable in a terminal" and "running production infrastructure."
...
The AI was indispensable throughout this process. It wrote the initial scripts, explained why specific configurations mattered, debugged the inevitable failures that came from trying things I'd never done before. Every choice in this series, from PHP-FPM's static process management mode to the fail2ban jail configurations to the Watchdog's restricted SSH shell, started as a conversation where I described the problem and AI proposed the solution. Sometimes the first proposal was wrong, and we iterated. Sometimes it was right and I didn't understand why until I read the documentation it pointed me toward.
...
The gap I crossed wasn't "non-developer to developer." I'm still not a developer. The gap was "I can follow instructions" to "I understand my infrastructure." Those are different things, and the distance between them is where the real learning happens.
...
*Previous: Part 6, ["Automating the Boring Parts"](2026-04-05-wp-infra-06-automating-the-boring-parts.md)*
