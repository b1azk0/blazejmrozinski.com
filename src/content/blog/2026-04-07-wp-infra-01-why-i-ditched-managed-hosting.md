...
> *This is Part 1 of "WordPress Infrastructure from Scratch," a hands-on guide to building production WordPress and WooCommerce hosting on Hetzner. Code and configs at the [companion repository](COMPANION_REPO_URL).*
...
Full configs for everything in this post are in the [companion repository](COMPANION_REPO_URL) under `01-server-provisioning/`.
